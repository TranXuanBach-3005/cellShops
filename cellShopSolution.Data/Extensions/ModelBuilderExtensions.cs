...
namespace cellShopSolution.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            // any guid
            var roleId = new Guid("55402DDF-8528-4DDA-A2CC-2D2FA73909FE");
            var adminId = new Guid("8049A3C9-F944-425A-B991-FFC5C2594218");
            ...
            modelBuilder.Entity<User>().HasData(new User
            {
                ...
                FistName = "Xuan",
                LastName = "Bach",
                BirthDay = new DateTime(2001, 01, 31)
            });
