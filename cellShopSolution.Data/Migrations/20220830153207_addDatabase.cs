        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SeoDescription = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    SeoTitle = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    LanguageId = table.Column<string>(type: "varchar(5)", unicode: false, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "OriginaPrice", "Price", "SeoAlias", "Stock" },
                values: new object[] { 1, new DateTime(2022, 8, 30, 22, 32, 6, 709, DateTimeKind.Local).AddTicks(8912), 100000m, 200000m, null, 0 });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("55402ddf-8528-4dda-a2cc-2d2fa73909fe"), "cc5163d8-0b1e-41ac-b3e6-b6cbd03fa438", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("55402ddf-8528-4dda-a2cc-2d2fa73909fe"), new Guid("8049a3c9-f944-425a-b991-ffc5c2594218") });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "BirthDay", "ConcurrencyStamp", "Email", "EmailConfirmed", "FistName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("8049a3c9-f944-425a-b991-ffc5c2594218"), 0, new DateTime(2001, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "132affef-10b4-4faa-ab53-503e40c1f620", "bachtran3005@gmail.com", true, "Xuan", "Bach", false, null, "bachtran3005@gmail.com", "admin", "AQAAAAEAACcQAAAAEF+9kkVpxyDDc1PMaRrCRqgIQ/jwX6X6lAPzUEsrw7Zd/TD9JXAsQB4OJnccr8fFqg==", null, false, "", false, "admin" });
